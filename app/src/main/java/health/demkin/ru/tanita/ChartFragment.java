...
/**
 * Created by evgen1000end on 08.03.2015.
 */
public class ChartFragment extends Fragment implements SeekBar.OnSeekBarChangeListener,
    ...
    private void setData(int count, float range) {
        ...
        List<TanitaState> tanitaStateList =   service.findAllStates();




        for (int i = 0; i < tanitaStateList.size(); i++) {

            float val =tanitaStateList.get(i).getWeight();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent,
        ...
        View v = inflater.inflate(R.layout.fragment_charts, parent, false);
